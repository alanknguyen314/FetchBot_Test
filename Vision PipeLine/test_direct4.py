...
def main():
    ...
    try:
        while True:
            ...
            if not prediction_made and initial_position and len(initial_position) == 3:
                ...
                if trajectory:
                    ...
                    adjusted_height = initial_position[1] - 1.0  # Adjust for camera height
                    if adjusted_height > 0:
                        time_to_ground = np.sqrt(2 * adjusted_height / 9.81)  # Free-fall time calculation
